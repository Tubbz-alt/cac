        ...
        if args.inputfile:
            ...
            for chip in range(cc.TOT_CHIPS):
                ...
                if args.extractpixel:
                    ...
                    np.savez("%s_%d_%d%s" % (filename, args.singlepixel[0], args.singlepixel[1],
                             '.npz'), px)

                if args.singlepixel:
                    # plot single pixel data [frames,y=row,x=col]
                    plt.plot(iasic[:, args.singlepixel[0],
                                   args.singlepixel[1]], '-.', label='ref', alpha=0.25)

                    plt.plot(iasic[:, args.singlepixel[0] - 2,
                                   args.singlepixel[1]], label='-2,0', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] - 1,
                                   args.singlepixel[1]], label='-1,0', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] + 2,
                                   args.singlepixel[1]], label='+2,0', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] + 1,
                                   args.singlepixel[1]], label='+1,0', alpha=0.75)
                    ...
                    plt.plot(iasic[:, args.singlepixel[0],
                                   args.singlepixel[1] + 1], label='0,+1', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] - 2,
                                   args.singlepixel[1] + 1], label='-2,+1', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] - 1,
                                   args.singlepixel[1] + 1], label='-1,+1', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] + 2,
                                   args.singlepixel[1] + 1], label='+2,+1', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] + 1,
                                   args.singlepixel[1] + 1], label='+1,+1', alpha=0.75)
                    ...
                    plt.plot(iasic[:, args.singlepixel[0],
                                   args.singlepixel[1] + 2], label='0,+2', alpha=0.75)
                    plt.plot(iasic[:, args.singlepixel[0] - 1,
                    ...
                    # reset aggressor to zero
                    iasic[:, args.singlepixel[0], args.singlepixel[1]] = 0

                    f, ax = plt.subplots(2, 2)
                    b_avg = np.average(iasic[:, args.singlepixel[0] - 5:args.singlepixel[0] + 6,
                    ...
                    im1 = ax[1, 0].imshow(b_std, cmap=cm.plasma)
                    f.colorbar(im1, ax=ax[1, 0])
                    ax[1, 1].hist(b_std.ravel(), bins='auto', histtype='step')
